                ...
                <div class="col-12">
                    ...
                    <div class="text-center">
                        <svg id="Layer_1" class="svg-computer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 424.2 424.2">
                            <style>
                                .st0{fill:none;stroke:#c6d1ff;stroke-width:5;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;}
                            </style>
                            <g id="Layer_2">
                        ...
                        <h3 class="mt-4 text-white">Kami sedang melakukan pemeliharaan</h3>
                        <p class="text-white-50">Kami membuat sistem lebih dahsyat. Kami akan segera kembali.</p>
